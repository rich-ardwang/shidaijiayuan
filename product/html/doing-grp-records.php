<?php
/*
 * doing-grp-records.php
 *
 * -handle the process of doing group records.
 *
    ...
    <body class="bg-dark">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md">
                    <div class="jumbotron jumbotron-fluid bg-primary">
                        <h1 class="display-5 text-center text-white">进行中的团购</h1>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md">
                    <div id="toolbar">
                        <button id="reloadDoingGpi" class="btn btn-primary">立刻刷新</button>
                    </div>
                    <table id="doingGpiTable" class="table-dark table-striped" data-mobile-responsive="true"></table>
                </div>                                       
            </div>
        ...
        <script src="../js/doing-grp-records.js"></script>
    </body>
</html>
