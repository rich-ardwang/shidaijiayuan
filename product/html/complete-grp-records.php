<?php
/*
 * complete-grp-records.php
 *
 * -handle the process of closed group records.
 *
...
<html lang="zh-CN">
    <head>
        ...
        <meta name="description" content="Create: 2022-04-14">
    ...
    <body class="bg-dark">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md">
                    <div class="jumbotron jumbotron-fluid bg-white">
                        <h1 class="display-5 text-center text-black-50">已封单的团购</h1>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md">
                    <div id="toolbar">
                        <button id="reloadClosedGpi" class="btn btn-primary">立刻刷新</button>
                    </div>
                    <table id="closedGpiTable" class="table-dark table-striped" data-mobile-responsive="true"></table>
                </div>                                       
            </div>
        ...
        <script src="../js/complete-grp-records.js"></script>
    </body>
</html>
