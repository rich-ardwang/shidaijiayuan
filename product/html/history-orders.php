 ...
 * history-orders.php
 *
 * -handle the process of history orders.
 *
...
<html lang="zh-CN">
    ...
    <body class="bg-dark">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md">
                    <div class="jumbotron jumbotron-fluid bg-info">
                        <h1 class="display-5 text-center text-white">历史订单</h1>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md">
                    <table id="historyOrdersTable" class="table-dark table-striped" data-mobile-responsive="true" data-show-export="true"></table>
                </div>                                       
            </div>
        ...
        <script src="../js/history-orders.js"></script>
    </body>
</html>
